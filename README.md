...
- [ ] Explain what a token is used for.
  Tokens are a way o save authentication on the client side .
- [ ] What steps can you take in your web apps to keep your data secure?
  By storing data on the server only being accessed by authorization

- [ ] Describe how web servers work.
  web servers are a computer connected to the internet that handles the interchange of information
